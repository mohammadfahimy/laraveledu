            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        @if($item_id == 'totalbasket') @continue @endif
                        <tr>
                            <td class="align-middle"><img src="img/product-1.jpg" alt="" style="width: 50px;"> {{ $item['name'] }} </td>
                            <td class="align-middle">تومان {{ number_format($item['price']) }}</td>
                            ...
                            <td class="align-middle"><a href="{{ route('basket.remove',$item_id) }}" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a></td>
                        </tr>     
                        @endforeach
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="border-bottom pb-2">
                        <div class="d-flex justify-content-between mb-3">
                            <h6>Subtotal</h6>
                            <h6>تومان {{ empty($basket['totalbasket']) ? App\Services\Basket\Basket::getTotalBasket(): $basket['totalbasket'] }}
                            </h6>
                        </div>
